...
class OutputLayer(Layer):
    def __init__(self, input_count, neuron_count, activation_function, cost_function, weights = None, biases = None):
        super(OutputLayer, self).__init__(input_count, neuron_count, activation_function, weights, biases)
